...
const Bullet = ({ children }) => (
  <li className="relative pl-4 leading-relaxed text-[11px] md:text-[11px]">
...
export default function Resume() {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      const options = {
        margin: 0,
        filename: "Krishnendu_Sarkar_Resume.pdf",
  ...
  return (
    <div className="min-h-screen w-full bg-gray-100 py-6 md:py-10">
      ...
      <div className="max-w-4xl mx-auto shadow-xl">
        <div
          ref={resumeRef}
          className="bg-white mx-auto w-full md:w-[794px] rounded-md border border-gray-200 overflow-hidden"
        >
          {/* Top header bar */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-0">
            ...
            <div className="md:col-span-4 border-b md:border-r md:border-b-0 px-4 md:px-8 pt-6 pb-6 md:pb-10 bg-gray-50">
              ...
              <div className="space-y-2 text-[11px] break-words">
                <div className="flex items-start gap-2">
                  <Phone size={14} className="mt-0.5 text-gray-700" />
                  <a
                    href="tel:+916290421047"
              ...
              <ul className="space-y-2">
                <Bullet>
                  Fast learner | Problem-Solving | Soft Skills | Team-oriented
                </Bullet>
              </ul>
            </div>
            ...
            <div className="md:col-span-8 px-4 md:px-8 pt-6 pb-6 md:pb-10">
              ...
              <p className="text-[11px] leading-relaxed text-gray-800">
                ...
                Engineering graduate (B.Tech, 2025) with strong expertise in web
                development and modern frameworks. Proficient in Backend
                development viz NextJS, MongoDB, SQL, JavaScript,Node.js,
                Express.js, with a solid foundation in data structures,
                algorithms, and object-oriented programming. Experienced in
                building responsive and scalable web applications. Known for
                strong problem-solving abilities, collaboration in team
                projects, and a passion for writing clean, maintainable code.
                Seeking to contribute technical skills and creativity in a
                dynamic software development role.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-1 mt-1">
                    ...
                    <li className="text-[11px]">Percentage - 75.7</li>
                  </ul>
                </div>
                <div>
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  ...
                  <ul className="space-y-1 mt-1">
                    ...
                    <li className="text-[11px]">Percentage - 81.7</li>
                  </ul>
                </div>
                <div>
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  ...
                  <ul className="space-y-1 mt-1">
                    <li className="text-[11px]">Science(Computer)</li>
                    <li className="text-[11px]">Percentage - 67.2</li>
                  </ul>
                </div>
              </div>
              ...
              <ul className="space-y-1">
                <Bullet>
                  AI Image Enhancer - A web application that uses AI to enhance
                  image quality. <br />
                  <a
                    href="https://ai-image-enhancer-pi-eight.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-teal-600 hover:underline text-[11px] md:text-[11px]"
                  >
                    View Project
                  </a>
                  <span className="block mt-1">Tech Stack :</span>
                  <ul className="list-disc list-inside text-[11px] md:text-[11px] pl-2">
                    <li>React.js - Frontend framework</li>
                    <li> Vite - Build tool</li>
                    <li>
                      External AI API - Used for image enhancement capabilities.
                    </li>
                  </ul>
                </Bullet>
                <Bullet>
                  Intellmeet - An interactive online AI meeting platform. <br />
                  <a
                    href="https://intellmeet.vercel.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-teal-600 hover:underline text-[11px] md:text-[11px]"
                  >
                  ...
                  <ul className="list-disc list-inside text-[11px] md:text-[11px] pl-2">
                    <li>
                      Groq AI - Used for seamless integration of AI
                      capabilities.
                    </li>
                    <li>
                      Cloudinary - Used for efficient media management and
                      delivery.
                    </li>
                    <li>Zustand - Used for lightweight state management.</li>
                    <li>
                      Recharts - Used for creating interactive data
                      visualizations.
                    </li>
                    <li>
                      Socket.io & WebRTC - Used for real-time communication
                      features.
                    </li>
                    <li>NodeMailer - Used for sending emails.</li>
                  </ul>
                </Bullet>
                <Bullet>
                  Cyberfiction - A 3D mouse movement tracking website. <br />
                  <a
                    href="https://cyberfiction-sigma.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-teal-600 hover:underline text-[11px] md:text-[11px]"
                  >
                  ...
                  <ul className="list-disc list-inside text-[11px] md:text-[11px] pl-2">
                    <li>
                      Locomotive Scroll - Smooth scrolling effects & custom
                      scroller container.
                    </li>
                    <li>GSAP - Core animation library.</li>
                    <li>
      ...
      <p className="max-w-4xl mx-auto text-[11px] md:text-[11px] text-gray-500 mt-4 px-3 md:px-0 text-center md:text-left">
